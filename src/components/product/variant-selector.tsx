          ...
          {option.values.map((value) => {
            ...
            return (
              <button
                ...
                className={clsx(
                  "flex min-w-[48px] items-center justify-center rounded-full border bg-accent px-2 py-1 text-sm",
                  {
                    ...
                    "relative z-10 cursor-not-allowed overflow-hidden bg-accent text-muted-foreground ring-1 ring-border before:absolute before:inset-x-0 before:-z-10 before:h-px before:-rotate-45 before:bg-border before:transition-transform":
                      !isAvailableForSale,
                  },
                )}
              >
