...
┌─────────────────────────────────────────────────────────────────────┐
│                                                                     │
│  [Full-width lifestyle image: Knob One on desk setup]               │
│                                                                     │
│  TYPE THE                                                           │
│  NEXT BIG                          ┌──────────────┐                │
│  THING.                            │  ORDER TODAY  │                │
│                                    └──────────────┘                │
│                    The Knob One™ is a keyboard made to              │
│                    endure long nights and launch parties.            │
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘
```
...
│  ┌──────────────────────────────┐  ┌─────────────────────────┐     │
│  │                              │  │                         │     │
│  │  WHY KEON?                   │  │  [Founder / brand       │     │
│  │                              │  │   lifestyle image]      │     │
│  │  A keyboard built for the    │  │                         │     │
│  │  ones who ship. We started   │  │                         │     │
│  │  Keon because ...            │  │                         │     │
│  │                              │  │                         │     │
│  └──────────────────────────────┘  └─────────────────────────┘     │
│                                                                     │
...
│  KEON                                                               │
│                                                                     │
│  Shop        Support       Legal          Follow Us                 │
│  Knob One    FAQ           Privacy        Instagram                 │
│  Accessories Contact       Terms          TikTok                    │
│              Shipping      Imprint        X / Twitter               │
│                                                                     │
│  © 2026 Keon. All rights reserved.                                  │
└─────────────────────────────────────────────────────────────────────┘
```
